<?php
  ...
  $sql = mysql_query("SELECT sum(sisa) as sisa, jenis_cuti FROM t_cuti WHERE nip='$nip' group by nip") or exit(mysql_error());
...
if ($_POST['lama_cuti'] == '') {
    ...
    mysql_query("insert into t_cuti(nip,tanggal_awal,tanggal_akhir,keperluan,relasi_nama,relasi_telepon,
									...
									'$relasi_hubungan','$nip_pengganti','$lama_cuti','$tahunan')") or exit(mysql_error());
