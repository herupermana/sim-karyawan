...
if (empty($aksi))
{
   ...
   where a.nip = b.nip and a.jenis_cuti = 'tahunan' order by  a.nip, a.tanggal_awal desc")or die(mysql_error());
?>
</p>
...
?>
      <tr class="tabelsorot">
		...
		<td class="tabelisi"><?  echo $t[sisa]. " hari"; ?></td>
        <td class="tabelisi" align="center">
		<? echo "<a href='$alamat&aksi=ubah&id=$t[id_cuti]' title='Ubah'>"; ?>
		<img src="images/b_edit.png" width="16" height="16" border="0" /></a></td>
        <td class="tabelisi" align="center">
		<? $no++; echo "<a href='$alamat&aksi=hapus&id=$t[id_cuti]' title='Hapus'>"; ?>
		<img src="images/b_drop.png" width="16" height="16" border="0" /></a></td>
		 <td class="tabelisi" align="center">
		<? echo "<a href='cetak_cuti_tahunan.php?id=$t[id_cuti]&no=$no' target='_blank' title='Hapus'>"; ?>cetak</a></td>
