...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    while ($t = mysql_fetch_array($q)) {
        ?>
      <tr class="tabelsorot">
        <td class="tabelisi" align="center"><?php echo $no; ?></td>
        <td class="tabelisi"><?php echo $t[nama_golongan]; ?></td>
        <td class="tabelisi" align="center">
		<?php echo "<a href='$alamat&aksi=ubah&id=$t[id_golongan]' title='Ubah'>"; ?>
		<img src="images/b_edit.png" width="16" height="16" border="0" /></a></td>
        <td class="tabelisi" align="center">
		<?php echo "<a href='$alamat&aksi=hapus&id=$t[id_golongan]' title='Hapus'>"; ?>
    ...
    <td class="bgform"><form id="golongan" name="golongan" method="post" action="prosesgolongan.php?aksi=ubah">
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
        ...
        <tr>
          ...
          <td><label>
            <input name="id_golongan" type="text" size="10" readonly <?php echo "value='$tubah[id_golongan]'"; ?> />
          </label></td>
        </tr>
        <tr>
          <td class="labelform">Nama Golongan</td>
          <td><label>
            <input name="nama_golongan" type="text" size="30" <?php echo "value='$tubah[nama_golongan]'"; ?>/>
          </label></td>
        </tr>
        <tr>
          <td class="labelform">&nbsp;</td>
    ...
    <td class="bgform"><form id="golongan" name="golongan" method="post" action="prosesgolongan.php?aksi=hapus">
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
        ...
        <tr>
          <td class="labelform">Kode</td>
          <td><label>
            <input name="id_golongan" type="text" size="10" readonly <?php echo "value='$thapus[id_golongan]'"; ?> />
          </label></td>
        </tr>
        <tr>
          <td class="labelform">Nama Golongan</td>
          <td><label>
            <input name="nama_golongan" type="text" size="30" readonly <?php echo "value='$thapus[nama_golongan]'"; ?>/>
          </label></td>
        </tr>
        <tr>
          <td class="labelform">&nbsp;</td>
