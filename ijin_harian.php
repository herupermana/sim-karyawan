...
<?php
	...
	<td class="tabelisi" align="center">
		<?php echo "<a href='cetak_permohonan_ijin_harian.php?id=$t[id]&no=$no' target='_blank' title='Hapus'>"; ?>cetak</a></td>
<?php
    } ?>
      <tr>
        <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
        ...
        <tr>
          ...
          <td><label>
            ...
            <label>
            <input name="tahun" type="text" id="tahun" size="3" <?php echo "value='$tahunsekarang'"; ?>/>
            </label> 
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="bgform"><form id="ijin" name="ijin" method="post" action="prosesijin.php?aksi=ubah">
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
        ...
        <tr>
          ...
          <td><label>
            ...
            <label>
            <input name="tahun" type="text" id="tahun" size="3" <?php echo "value='$Fthn'"; ?> />
            </label> 
			   </td>
        </tr>
         <tr>
      ...
      <!-- <tr>
          <td class="labelform">Ijin Untuk</td>
          <td><input name="ijin_untuk" type="text" id="ijin_untuk" size="50" <?php echo "value='$t[ijin_untuk]'"; ?>/></td>
        </tr>-->
       <tr>
          <td class="labelform">Keperluan</td>
        ...
        <tr>
          <td class="labelform">Alamat</td>
          <td><input name="relasi_alamat" type="text" id="relasi_alamat" size="50" <?php echo "value='$t[relasi_alamat]'"; ?>/></td>
        </tr>
        <tr>
          <td class="labelform">Telepon</td>
          <td><input name="relasi_telepon" type="text" id="relasi_telepon" size="50" <?php echo "value='$t[relasi_telepon]'"; ?>/></td>
        </tr>
        <tr>
          <td class="labelform">Hubungan</td>
          <td><input name="relasi_hubungan" type="text" id="relasi_hubungan" size="50" <?php echo "value='$t[relasi_hubungan]'"; ?>/></td>
        </tr>
        <tr>
          <td colspan="2" class="labelform" align="right"><label>
