...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><a href="ccuti_hamil.php" class="versicetak" target="_blank">Versi Cetak</a> </td>
  </tr>
</table>
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="bgform"><form id="cuti" name="cuti" method="post" action="prosescuti_hamil.php?aksi=tambah" onSubmit="MM_validateForm('keperluan','','R');return document.MM_returnValue">
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
        <tr>
          <td colspan="2" class="judulform">Isi Cuti Hamil Karyawan</td>
          </tr>
        <tr>
          <td width="24%">&nbsp;</td>
          <td width="76%">&nbsp;</td>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="bgform"><form id="cuti" name="cuti" method="post" action="prosescuti_hamil.php?aksi=ubah">
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
        <tr>
          <td colspan="2" class="judulform">Ubah Cuti Hamil Karyawan</td>
          </tr>
        <tr>
          <td width="24%">&nbsp;</td>
